def add_edge_traffic_times(G, traffic_signals_time=2, stop_time=2, turning_circle_time=0, crossing_time=1.5,
                           give_way_time=1.5, mini_roundabout_time=1.5):
    """
...
def get_slight_turn_penalty_dict(G, left_turn_penalty=30, slight_left_turn_penalty = 20, right_turn_penalty=10, slight_right_turn_penalty = 20, u_turn_penalty=90):
    """
  Calculate turn penalties for different types of turns at intersections in a graph.
  ...
  **kwargs : keyword arguments
  ...
  """
    ...
    for i in range(len(origins_gdf)):
        ...
        dest_node = ox.distance.nearest_nodes(G, destinations_gdf.iloc[i]['geometry'].x,
