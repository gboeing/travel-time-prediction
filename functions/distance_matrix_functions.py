...
def batch_distance_requests(origins, destinations, mode, batch_size, departure_time=None):
    ...
    for i in range(0, len(origins), batch_size):
        ...
        for origin, destination in zip(batch_origins, batch_destinations):
            ...
            if cached_data:
                ...
                # request
                response = gmaps.distance_matrix(origin, destination, mode=mode, departure_time=departure_timestamp)
