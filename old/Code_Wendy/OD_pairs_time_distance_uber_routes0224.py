...
from functions.penalty_functions_update import (
    add_edge_traffic_times_non_simplified,
    get_slight_turn_penalty_dict,
...
def calculate(
    ...
    slight_left_turn_penalty=10,
    right_turn_penalty=15,
    slight_right_turn_penalty=5,
    u_turn_penalty=50,
):
...
def run():
    ...
    turn_penalty = get_slight_turn_penalty_dict(
        G,
        left_turn_penalty=27.2,
        slight_left_turn_penalty=16,
        right_turn_penalty=24,
        slight_right_turn_penalty=8.7,
        u_turn_penalty=16.8,
    )
    ...
    df.to_csv(
        ...
        + f"{routing_algorithm}_OD3am_all_googlerouteapi_simplified_parsi_model2.csv",
    )
