...
\begin{table*}[tb!]
    ...
    \begin{tabular}{lrrrrrrr}
        ...
        \midrule
        Initial naïve       & 21.15 & 183.69 & 48214.06 &  -182.85 & <0.01 & 0.79 & 0.74  \\
        \textbf{Random forest}       &  \textbf{8.42} &  \textbf{75.32} & \textbf{12154.79} &     \textbf{0.38} &  \textbf{0.76} & \textbf{1.01} & \textbf{0.93}  \\
